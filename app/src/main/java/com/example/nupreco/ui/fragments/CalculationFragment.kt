...
import com.example.nupreco.databinding.FragmentCalculationBinding
import com.example.nupreco.viewmodel.CalculationViewModel
...
class CalculationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        calculationViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        return root
    }
